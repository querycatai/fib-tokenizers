...
inline char32_t utf_getchar(const char*& src, const char* end)
{
    if (src >= end)
        return 0;
...
inline ssize_t utf_putchar(char32_t ch, char*& dst, const char* end)
{
    if (dst >= end)
        return 0;
...
inline char32_t utf_getchar(const char16_t*& src, const char16_t* end)
{
    if (src >= end)
        return 0;
...
inline ssize_t utf_putchar(char32_t ch, char16_t*& dst, const char16_t* end)
{
    if (dst >= end)
        return 0;
...
inline char32_t utf_getchar(const char32_t*& src, const char32_t* end)
{
    if (src >= end)
        return 0;
...
inline ssize_t utf_putchar(char32_t ch, char32_t*& dst, const char32_t* end)
{
    if (dst >= end)
        return 0;
...
template <typename T1, typename T2>
inline ssize_t convert(const T1* src, ssize_t srclen, T2* dst, ssize_t dstlen)
{
    if (!dst)
        return _test(src, srclen, dst);
